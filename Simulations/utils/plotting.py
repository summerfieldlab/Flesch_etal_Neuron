...
def scatter_mds_2(xyz,task_id='a',fig_id=1,flipdims=False,items_per_dim=5,flipcols=False):
    ...
    ctxMarkerSize = 4
    itemMarkerSize = 1
    scat_b = np.linspace(.5,2.5,items_per_dim)
...
def plot_mds(data,ndims=2,fig_id=1):
