function stats = rsa_roi_sigtest(maskName)
  %% rsa_roi_sigtest()
  %
  ...
  % load correlations
  load(fullfile(params.dir.outDir, ['groupAvg_' params.names.betasOut '_' maskName '.mat']));
  ...
  save(fullfile(params.dir.outDir, ['groupAvg_STATS_' params.names.betasOut '_' maskName '.mat']),'stats');
