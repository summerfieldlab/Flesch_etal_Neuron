function params = glm_3_signeddist_params()
    %% glm_3_signeddist_params()
    %
    ...
    params.glmName = 'glm_3_signeddist';
    % directories
    params.projectdir = 'REPLACEWITHREPOSITORYDIR';
    ...
    params.num.conditions = 3; % number of conditions
