function wrapper_rsa_roi_switchstay_glm7()
    %% wrapper_rsa_roi()
    %
    ...
    for maskID = 1:length(roilist)
       ...
       rsa_compute_performRSA_ROI_switchstay_glm7(mask,'switch');
       rsa_compute_performRSA_ROI_switchstay_glm7(mask,'stay');
