function params = rsa_corrs_setParams()
  %% RSA_CORRS_SETPARAMS()
  %
...
% params.dir.projectDir = 'project';
  ...
  params.dir.outDir   =  'project/results_paper/rsa/';
  ...
  params.names.rdmSetIn    =        'rdmSet_cval_slRSA_paper_';
  params.names.rdmSetOut   =        'rdmSet_cval_slRSA_paper_';
  params.names.corrsOut    =    'modelBetas_cval_slRSA_paper_';
