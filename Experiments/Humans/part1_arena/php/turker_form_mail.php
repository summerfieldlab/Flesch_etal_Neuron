  ...
  <form action="javascript:getTurkerform();goWebsite(html_instructions);" method="POST">
    ...
    <div class="bodyBox">
      ...
      <table style="position:         absolute;
        ...
        <tr>
          <td style="padding-top:10px; padding-bottom:10px;">
            <b>If you want us to send you a reminder via e-mail when the second part of the experiment is ready, you can introduce it here (this is not required) : </b>
          </td>
          <td>
            <input type="text" id="emailSelect"><br>
          </td>
        </tr>
      </table>
